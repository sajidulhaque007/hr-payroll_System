    ...
    <div class="leftside-menu">
        ...
        <div class="h-100" id="leftside-menu-container" data-simplebar>
            ...
            <ul class="side-nav">
                ...
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#sidebarCompany" aria-expanded="false"
                       aria-controls="sidebarCompany" class="side-nav-link">
                        <i class="uil-store"></i>
                    ...
                    <div class="collapse" id="sidebarCompany">
                        <ul class="side-nav-second-level">
                            ...
                            <li>
                                <a href="{{route('company.manage')}}">Manage Company</a>
                            </li>
                ...
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#sidebarDepartment" aria-expanded="false"
                       aria-controls="sidebarDepartment" class="side-nav-link">
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="sidebarEmployee">
                        <ul class="side-nav-second-level">
                            ...
                            <li>
                                <a href="{{route('employee.manage')}}">Manage Employee</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="sidebarAttendance">
                        <ul class="side-nav-second-level">
                            <li>
                                <a href="{{ route('attendance.add') }}">Add Attendance</a>
                            </li>
                        </ul>
                    </div>
                </li>

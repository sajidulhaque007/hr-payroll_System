...
@section('body')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Add Company form</h4>
                    <form class="form-horizontal" action="{{ route('company.new') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-9">
                                <input type="text" class="form-control" name="support_number" placeholder="support number">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-3 col-form-label">Social address</label>
                            <div class="col-9">
                                <input type="text" class="form-control" name="social_address" placeholder="social address">
                            </div>
                        </div>

                        <div class="justify-content-end row">
                            <div class="col-9">
                                <button type="submit" class="btn btn-info">Create New Company</button>
                            </div>
                        </div>
                    </form>
